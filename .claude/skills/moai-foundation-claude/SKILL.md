...
- reference/claude-code/skills.md - Agent Skills creation and management
- reference/claude-code/sub-agents.md - Sub-agent development and delegation
- reference/claude-code/extensions.md - Extensions and plugins
- reference/advanced/skill-guide.md - Custom commands and advanced skills

Configuration:

- reference/claude-code/settings.md - Configuration hierarchy and management
- reference/claude-code/memory.md - Context and knowledge persistence
- reference/advanced/hooks-guide.md - Event-driven automation
- reference/advanced/mcp-servers.md - MCP Servers configuration

Advanced Features:

- reference/claude-code/cli-reference.md - Command-line interface
- reference/advanced/claude-md-guide.md - CLAUDE.md Guide
- reference/advanced/agent-guide.md - Advanced agent patterns
- reference/advanced/builder-agents.md - Builder Agents Guide
- reference/advanced/pencil-guide.md - Pencil Guide
- reference/advanced/stitch-guide.md - Google Stitch Guide
