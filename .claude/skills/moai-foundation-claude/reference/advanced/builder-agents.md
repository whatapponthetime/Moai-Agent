[Skip to Content](https://adk.mo.ai.kr/en/advanced/builder-agents#nextra-skip-nav)

[Advanced](https://adk.mo.ai.kr/en/advanced/skill-guide "Advanced") Builder Agents Guide
...
## What are Builder Agents? [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#what-are-builder-agents)
...
### 4 Types of Extensions [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#4-types-of-extensions)
...
## Creating Skills (builder-skill) [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#creating-skills-builder-skill)

### What is a Skill? [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#what-is-a-skill)
...
### YAML Frontmatter Schema [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#yaml-frontmatter-schema)
...
### Frontmatter Field Details [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#frontmatter-field-details)
...
### Skill Directory Structure [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#skill-directory-structure)
...
### String Substitutions [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#string-substitutions)
...
### Dynamic Context Injection [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#dynamic-context-injection)
...
### Invocation Control Modes [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#invocation-control-modes)
...
### Repository Priority [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#repository-priority)
...
### Creating Skills [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#creating-skills)
...
## Creating Agents (builder-agent) [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#creating-agents-builder-agent)

### Agent Definition Structure [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#agent-definition-structure)
...
### Agent Frontmatter Field Details [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#agent-frontmatter-field-details)
...
### Permission Modes [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#permission-modes)
...
### Ways to Create Agents [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#ways-to-create-agents)
...
### Agent Repository Priority [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#agent-repository-priority)
...
### Built-in Agent Types [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#built-in-agent-types)
...
### Skills Preloading [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#skills-preloading)
...
### Hooks Configuration [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#hooks-configuration)
...
### Key Constraints [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#key-constraints)
...
## Creating Plugins (builder-plugin) [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#creating-plugins-builder-plugin)

### What is a Plugin? [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#what-is-a-plugin)
...
### Plugin Directory Structure [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#plugin-directory-structure)
...
### Plugin Manifest (plugin.json) [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#plugin-manifest-pluginjson)
...
### Field Details [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#field-details)
...
### Path Rules [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#path-rules)

- All paths are relative to the plugin root
- All paths must start with **”./”**
- Available environment variables: `${CLAUDE_PLUGIN_ROOT}`, `${CLAUDE_PROJECT_DIR}`

### Marketplace Setup (marketplace.json) [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#marketplace-setup-marketplacejson)
...
### Installation Scopes [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#installation-scopes)
...
### Plugin Installation and Management [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#plugin-installation-and-management)
...
### Plugin Caching and Security [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#plugin-caching-and-security)
...
### Real-World Plugin Creation Example [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#real-world-plugin-creation-example)
...
## Custom Preservation Locations [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#custom-preservation-locations)
...
## How to Invoke Builder Agents [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#how-to-invoke-builder-agents)
...
## Key Constraints [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#key-constraints-1)
...
## Related Documentation [Permalink for this section](https://adk.mo.ai.kr/en/advanced/builder-agents\#related-documentation)

- [Skill Guide](https://adk.mo.ai.kr/advanced/skill-guide) \- Skill system details
- [Agent Guide](https://adk.mo.ai.kr/advanced/agent-guide) \- Agent system details
- [Hooks Guide](https://adk.mo.ai.kr/advanced/hooks-guide) \- Event automation
- [settings.json Guide](https://adk.mo.ai.kr/advanced/settings-json) \- Configuration management
...
[Agent Guide](https://adk.mo.ai.kr/en/advanced/agent-guide "Agent Guide") [Hooks Guide](https://adk.mo.ai.kr/en/advanced/hooks-guide "Hooks Guide")
