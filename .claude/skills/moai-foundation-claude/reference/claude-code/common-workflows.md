[Skip to Content](https://adk.mo.ai.kr/en/claude-code/common-workflows#nextra-skip-nav)

[Claude Code](https://adk.mo.ai.kr/en/claude-code "Claude Code") Common Workflows

Copy page

# Common Workflows

Practical workflows for everyday development. Includes exploring unfamiliar code, debugging, refactoring, writing tests, creating PRs, and session management. Each section includes example prompts you can adapt to your project. For higher-level patterns and tips, see [Best Practices](https://adk.mo.ai.kr/claude-code/best-practices).

## Understanding a New Codebase [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#understanding-a-new-codebase)

### Get a Quick Codebase Overview [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#get-a-quick-codebase-overview)
...
### Finding Related Code [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#finding-related-code)
...
## Fixing Bugs Efficiently [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#fixing-bugs-efficiently)
...
## Refactoring Code [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#refactoring-code)
...
## Using Specialized Subagents [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#using-specialized-subagents)
...
## Safe Code Analysis with Plan Mode [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#safe-code-analysis-with-plan-mode)
...
### When to Use Plan Mode [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#when-to-use-plan-mode)
...
### How to Use Plan Mode [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#how-to-use-plan-mode)
...
### Example: Planning Complex Refactoring [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#example-planning-complex-refactoring)
...
## Testing Work [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#testing-work)
...
## Creating Pull Requests [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#creating-pull-requests)
...
## Working with Documentation [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#working-with-documentation)
...
## Working with Images [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#working-with-images)
...
## File and Directory References [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#file-and-directory-references)
...
## Using Extended Thinking (Thinking Mode) [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#using-extended-thinking-thinking-mode)
...
### Configuring Thinking Mode [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#configuring-thinking-mode)
...
## Restarting Previous Conversations [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#restarting-previous-conversations)
...
### Naming Sessions [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#naming-sessions)
...
## Running Parallel Claude Code Sessions with Git Worktree [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#running-parallel-claude-code-sessions-with-git-worktree)
...
## Using Claude as Unix-Style Utility [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#using-claude-as-unix-style-utility)

### Add Claude to Validation Pipeline [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#add-claude-to-validation-pipeline)
...
### Piping, Piping Out [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#piping-piping-out)
...
### Controlling Output Format [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#controlling-output-format)
...
## Asking Claude About Features [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#asking-claude-about-features)

Claude has built-in access to its own documentation and can answer questions about its capabilities and limitations.

### Example Questions [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#example-questions)
...
## Next Steps [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/common-workflows\#next-steps)

- [How It Works](https://adk.mo.ai.kr/claude-code/how-it-works) \- Understand the agent loop, tools, context management
- [Best Practices](https://adk.mo.ai.kr/claude-code/best-practices) \- Tips from environment configuration to parallel sessions
...
- [Common workflows](https://adk.mo.ai.kr/claude-code/common-workflows)

Last updated onFebruary 12, 2026

[How It Works](https://adk.mo.ai.kr/en/claude-code/how-it-works "How It Works") [Skills](https://adk.mo.ai.kr/en/claude-code/skills "Skills")
