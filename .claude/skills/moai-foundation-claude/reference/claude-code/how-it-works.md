[Skip to Content](https://adk.mo.ai.kr/en/claude-code/how-it-works#nextra-skip-nav)

[Claude Code](https://adk.mo.ai.kr/en/claude-code "Claude Code") How It Works
...
This guide covers core architecture, built-in features, and tips for working effectively. For step-by-step workflows, see [Common Workflows](https://adk.mo.ai.kr/claude-code/common-workflows). For extensions like skills, MCP, and hooks, see [Extensions](https://adk.mo.ai.kr/claude-code/extensions).

## The Agent Loop [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#the-agent-loop)
...
### The Model [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#the-model)
...
### The Tools [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#the-tools)
...
**Extending Beyond Basic**: Built-in tools are just the foundation. You can extend what Claude knows with skills, connect to external services with MCP, automate workflows with hooks, and delegate tasks with subagents. These extensions form layers on top of the core agent loop. For guidance on choosing the right extensions, see [Claude Code Extensions](https://adk.mo.ai.kr/claude-code/extensions).

## What Claude Can Access [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#what-claude-can-access)
...
## Working with Sessions [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#working-with-sessions)
...
### Working Across Branches [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#working-across-branches)
...
### Resume or Fork Sessions [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#resume-or-fork-sessions)
...
### Context Window [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#context-window)
...
#### When Context Is Full [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#when-context-is-full)
...
#### Managing Context with Skills and Subagents [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#managing-context-with-skills-and-subagents)
...
## Staying Safe with Checkpoints and Permissions [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#staying-safe-with-checkpoints-and-permissions)
...
### Undo Changes with Checkpoints [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#undo-changes-with-checkpoints)
...
### Control What Claude Can Do [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#control-what-claude-can-do)
...
## Working Effectively with Claude Code [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#working-effectively-with-claude-code)

These tips will help you get better results with Claude Code.

### Ask Claude Code for Help [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#ask-claude-code-for-help)
...
### It’s a Conversation [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#its-a-conversation)
...
#### Interrupting and Course Correcting [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#interrupting-and-course-correcting)
...
### Be Specific Upfront [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#be-specific-upfront)
...
### Give Claude Something to Verify Against [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#give-claude-something-to-verify-against)
...
### Explore Before Implementing [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#explore-before-implementing)
...
### Delegate, Don’t Micromanage [Permalink for this section](https://adk.mo.ai.kr/en/claude-code/how-it-works\#delegate-dont-micromanage)
...
[Quick Start](https://adk.mo.ai.kr/en/claude-code/quickstart "Quick Start") [Common Workflows](https://adk.mo.ai.kr/en/claude-code/common-workflows "Common Workflows")
