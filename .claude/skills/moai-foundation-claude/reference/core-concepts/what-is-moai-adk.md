[Skip to Content](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk#nextra-skip-nav)
...
## MoAI-ADK Introduction [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#moai-adk-introduction)
...
## Why MoAI-ADK? [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#why-moai-adk)

### Problems with Vibe Coding [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#problems-with-vibe-coding)
...
### MoAI-ADK Solutions [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#moai-adk-solutions)
...
## Core Philosophy [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#core-philosophy)
...
## Key Components [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#key-components)

MoAI-ADK is composed of three axes: **agents**, **skills**, and **commands**.

### Agents (20) [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#agents-20)
...
### Skills (52) [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#skills-52)
...
### Commands (8) [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#commands-8)
...
## 3-Phase Development Workflow [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#3-phase-development-workflow)
...
## MoAI Orchestrator [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#moai-orchestrator)
...
## Project Structure [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#project-structure)
...
## Multilingual Support [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#multilingual-support)
...
## Next Steps [Permalink for this section](https://adk.mo.ai.kr/en/core-concepts/what-is-moai-adk\#next-steps)

Now that you understand the big picture of MoAI-ADK, it’s time to learn each core concept in detail.

- [SPEC-Based Development](https://adk.mo.ai.kr/core-concepts/spec-based-dev) — Learn how to define requirements as documents
- [Domain-Driven Development](https://adk.mo.ai.kr/core-concepts/ddd) — Learn how to safely improve existing code
- [TRUST 5 Quality](https://adk.mo.ai.kr/core-concepts/trust-5) — Learn how to automatically validate code quality

Last updated onFebruary 12, 2026

[CLI Reference](https://adk.mo.ai.kr/en/getting-started/cli "CLI Reference") [SPEC-Based Development](https://adk.mo.ai.kr/en/core-concepts/spec-based-dev "SPEC-Based Development")
