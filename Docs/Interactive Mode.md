...
description: "Complete reference to keyboard shortcuts, input modes, and interactive features of Claude Code sessions."
---
...
|------|-------------|----------|
| Start with `/` | Command or skill | See [Built-in commands](#built-in-commands) and [Skills](/claude-code/extensions) |
...
To create custom commands invoked with `/`, see [Skills](/claude-code/extensions).
...
- [Extensions](/claude-code/extensions) - Custom prompts and workflows
- [Checkpointing](/claude-code/checkpointing) - Rewind Claude's edits and restore previous states
- [CLI reference](/claude-code/cli-reference) - Command-line flags and options
- [Settings](/claude-code/settings) - Configuration options
- [Memory management](/claude-code/memory) - Managing CLAUDE.md files
